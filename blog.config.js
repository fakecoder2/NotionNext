...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'a03c21a382eb4a66824d503bc4540896',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ziweii', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '产品🍚', // 作者简介
  ...
  //   ********挂件组件相关********
  // Chatbase
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'IaJpn7YMSO1SDaUx5aSp2' // 是否显示chatbase机器人 https://www.chatbase.co/
  // 悬浮挂件
